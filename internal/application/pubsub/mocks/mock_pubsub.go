...
<<<<<<< HEAD:internal/infrastructure/redis/mocks/mock_pubsub.go
// Source: github.com/Soyuen/go-redis-chat-server/internal/application/pubsub (interfaces: PubSub,Subscription)
=======
// Source: go-redis-chat-server/internal/application/pubsub/ports.go
>>>>>>> ad7c88e (refactor: relocate mocks and interfaces to application layer):internal/application/pubsub/mocks/mock_pubsub.go
