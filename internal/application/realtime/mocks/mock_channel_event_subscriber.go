...
// Source: github.com/Soyuen/go-redis-chat-server/internal/application/realtime (interfaces: ChannelEventSubscriber)
...
func (m *MockChannelEventSubscriber) Start(arg0 string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Start", arg0)
}

// Start indicates an expected call of Start.
func (mr *MockChannelEventSubscriberMockRecorder) Start(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Start", reflect.TypeOf((*MockChannelEventSubscriber)(nil).Start), arg0)
}
